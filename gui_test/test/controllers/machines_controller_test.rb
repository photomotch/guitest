...
class MachinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post machines_url, params: { machine: { cpus: @machine.cpus, disk: @machine.disk, hostname: @machine.hostname, instance: @machine.instance, ipaddr: @machine.ipaddr, machineid: @machine.machineid, memory: @machine.memory, status: @machine.status } }
    end
  ...
  test "should update machine" do
    patch machine_url(@machine), params: { machine: { cpus: @machine.cpus, disk: @machine.disk, hostname: @machine.hostname, instance: @machine.instance, ipaddr: @machine.ipaddr, machineid: @machine.machineid, memory: @machine.memory, status: @machine.status } }
